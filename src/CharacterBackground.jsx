...
export default function characterBackground({ styles }) {
	...
	return (
		<Card styles={" " + styles}>
			<select
				className="h-full w-full p-1 border-slate-300 border bg-slate-200 dark:border-slate-900 rounded-xs focus:ring-2 focus:ring-theme-500 focus:outline-none dark:ring-1 dark:ring-white/5 dark:focus:ring-2 dark:focus:ring-theme-500"
				onChange={(e) =>
